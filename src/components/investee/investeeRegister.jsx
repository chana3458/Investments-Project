      ...
      <div className={`register-card ${isLoaded ? 'loaded' : ''}`}>
        ...
        <div className="register-form">
          ...
          <div className="form-group">
            ...
            <input 
              type="text" 
              value={newInvestee.fullname}
              onChange={e => setNewInvestee({...newInvestee, fullname: e.target.value})}
        ...
        <div className="form-actions">
          <button 
            ...
            disabled={isSubmitting}
          >
            {isSubmitting ? "Processing..." : "Register As Property Owner"}
          </button>
